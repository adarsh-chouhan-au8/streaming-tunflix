...
const Modal = ({ open, handleClose, videoLinks, tmdbId, title }) => {
    ...
    const videoJsOptions = (urls) => {
        return {
            ...
            controls: true,
            sources: [
                { label: 'french', src: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4", type: "video/mp4" },
                { label: 'english', src: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4", type: "video/mp4" },
            ],
            tracks: [
                {
                    kind: "captions",
